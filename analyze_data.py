...
class SPXOptionsAnalyzer:
    def __init__(self, csv_path='spx_0dte_combined.csv'):
    ...
    def create_visualizations(self):
        ...
        plt.tight_layout()
        plt.savefig('spx_0dte_analysis.png', dpi=300, bbox_inches='tight')
        plt.show()
        
        print("\nVisualization saved as 'spx_0dte_analysis.png'")
...
if __name__ == "__main__":
    ...
    print("\n" + "="*60)
    print("Analysis complete! Check 'spx_0dte_analysis.png' for visualizations.")
    print("="*60)