...
def load_and_process_dataset():
    ...
    csv_files = glob.glob('dataset/source/*.csv')
...
if __name__ == "__main__":
    ...
    df.to_csv('dataset/processed/spx_0dte_combined.csv', index=False)
    print(f"\nSaved combined dataset to 'dataset/processed/spx_0dte_combined.csv'")
